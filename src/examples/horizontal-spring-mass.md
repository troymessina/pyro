...
A mass connected to a spring oscillates horizontally on a frictionless surface. The spring force (Hooke's law) and damping are computed from physics, producing realistic oscillatory motion.
...
- **Net force**: \( F_{total} = F_{spring} = -kx \)
